...
sudo docker run -d --name mongo -v /home/uadm/mongo.conf:/etc/mongo.conf -v /home/uadm/key.txt:/etc/key.txt -p 27017:27017 –e MONGODB_INITDB_ROOT_USERNAME=omnipotent -e MONGODB_INITDB_ROOT_PASSWORD=123456 --add-host kassaprod01:10.10.15.40 --add-host kassaprod02:10.10.15.41 --add-host kassagw:10.10.15.39  10.10.12.99:5000/cashier/mongodb-enterprise-4.4.19 mongod --config /etc/mongo.conf
...
-p 27017:27017 \
--add-host kassaprod01:10.10.15.40 \
--add-host kassaprod02:10.10.15.41 \
--add-host kassaapp01:10.10.15.37 \
...
•	kassaprod01 – Primary узел – 10.10.15.40 – приоритет репликации - 3
•	kassaprod02 – Secondary узел – 10.10.15.41 - приоритет репликации - 2
•	kassaapp01 – Secondary узел – 10.10.15.37 - приоритет репликации - 1
...
--add-host kassaprod02:10.10.15.41 \
--add-host kassaapp01:10.10.15.37 \
10.10.12.99:5000/mongo:4.4.19 mongod --config /etc/mongo.conf
...
db.auth('omnipotent','$secretPassw0rd!')
